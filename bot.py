...
def admin_menu():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🚀 𝐌𝐎𝐑𝐄 𝐅𝐄𝐀𝐓𝐔𝐑𝐄𝐒", callback_data="admin_features"), InlineKeyboardButton("⚙️ 𝐒𝐄𝐓𝐓𝐈𝐍𝐆𝐒", callback_data="admin_settings")],
...
/tag [message] — Tag known group members (admin only)
/tagall [message] — Same as /tag
/rank — Your group XP, level and rank
/top — Top 10 group leaderboard
/coins — Check your coin balance
/dailycoins — Claim daily coins
/gift <amount> — Gift coins by replying to a member
/runall — Owner safe test of bot systems
