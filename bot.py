...
async def run_bot():
    ...
    # Register Telegram command menu so typing "/" in group chats
    # shows this bot's commands automatically.
    bot_commands = [
        ("start", "Start the bot"),
        ...
        ("myref", "Show your referrals"),
        ("advstats", "Advanced statistics"),
        ("dm", "Message the owner"),
        ("cancel", "Cancel current operation"),
        ("love", "Love calculator"),
        ("dice", "Roll a dice"),
        ("quote", "Random quote"),
        ("stats", "Show your stats"),
        ("profile", "Show group profile"),
        ("settitle", "Set a custom title"),
        ("cleartitle", "Clear custom title"),
        ("redeem", "Redeem a coin code"),
        ("analytics", "Group analytics"),
        ("autoclean", "Auto-clean settings"),
        ("giveaway", "Create a giveaway"),
        ("rank", "View group rank"),
        ("vip", "VIP status"),
        ("elite", "Elite status"),
        ("giveelite", "Give Elite access"),
        ("removeelite", "Remove Elite access"),
        ("givevip", "Give VIP access"),
        ("removevip", "Remove VIP access"),
        ("top", "View top group members"),
        ("testgreet", "Test group greeting"),
        ("coins", "Check your coins"),
        ("shop", "Open the coin shop"),
        ("dailycoins", "Claim daily coins"),
        ("gift", "Gift coins to a member"),
        ("runall", "Run a one-time test"),
        ...
        ("setpromo", "Set group promotion"),
        ("autopromo_on", "Enable auto promotion"),
        ("autopromo_off", "Disable auto promotion"),
        ("welcome", "Welcome settings"),
        ("automod", "Auto-moderation settings"),
        ("protection", "Protection settings"),
        ("linkprotect", "Link protection"),
        ("forwardprotect", "Forward protection"),
        ("voice", "Send voice from text"),
        ("tag", "Tag group members"),
        ("tagall", "Tag all known members"),
    ]
    command_objects = [BotCommand(name, description) for name, description in bot_commands]
    try:
        await app.bot.set_my_commands(command_objects)
        await app.bot.set_my_commands(
            command_objects,
            scope=BotCommandScopeAllGroupChats(),
        )
        print("✅ Telegram command menu registered for groups.")
    except Exception as e:
        print(f"⚠️ Command menu registration failed: {e}")
